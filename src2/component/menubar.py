...
def show_help():
    QMessageBox.information(None, "Help", "This is the Help section. Provide instructions here.")


def show_about():
    QMessageBox.information(None, "About", "This is a sample application built with PySide6.")
